...
public class AddLuceneWork extends LuceneWork implements Serializable {
	...
	public AddLuceneWork(Serializable id, String idInString, Class<?> entity, Document document, List<CategoryPath> categories) {
		this( id, idInString, entity, document, categories, null );
	}

	public AddLuceneWork(Serializable id, String idInString, Class<?> entity, Document document, List<CategoryPath> categories, Map<String, String> fieldToAnalyzerMap) {
