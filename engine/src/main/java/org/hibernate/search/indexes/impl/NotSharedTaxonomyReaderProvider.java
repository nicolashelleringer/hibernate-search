 ...
 */
public class NotSharedTaxonomyReaderProvider implements DirectoryBasedTaxonomyReaderProvider {
	...
	@Override
	public TaxonomyReader openTaxonomyReader() {
	...
	@Override
	public void closeTaxonomyReader(TaxonomyReader reader) {
		try {
			reader.close();
		}
		catch ( IOException e ) {
	...
	public void initialize(DirectoryBasedIndexManager indexManager, Properties props) {
		directoryProvider = indexManager.getTaxoDirectoryProvider();
