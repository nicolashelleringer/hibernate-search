...
public interface GeometricConstants {
	...
	double WHOLE_CIRCLE_RADIAN_RANGE= 2 * Math.PI;
	double LONGITUDE_RADIAN_RANGE = WHOLE_CIRCLE_RADIAN_RANGE;
	double LONGITUDE_RADIAN_MIN = -LONGITUDE_RADIAN_RANGE / 2;
	double LONGITUDE_RADIAN_MAX = LONGITUDE_RADIAN_RANGE / 2;
	double LATITUDE_RADIAN_RANGE = WHOLE_CIRCLE_RADIAN_RANGE / 2;
	double LATITUDE_RADIAN_MIN = -LATITUDE_RADIAN_RANGE / 2;
	double LATITUDE_RADIAN_MAX = LATITUDE_RADIAN_RANGE / 2;
	int HEADING_NORTH = 0;
